...
def submit_action():
    ...
    train_data = pd.read_csv("C:/Users/MITHUN/OneDrive/Desktop/Training Matches IPL 2008-2019.csv")
    #train_data
...
#
    ...
    train_data.replace({"Mumbai Indians":"MI", "Delhi Capitals":"DC",  "Sunrisers Hyderabad":"SRH", "Rajasthan Royals":"RR", "Kolkata Knight Riders":"KKR", "Kings XI Punjab":"KXIP", "Chennai Super Kings":"CSK", "Royal Challengers Bangalore":"RCB","Kochi Tuskers Kerala":"KTK", "Rising Pune Supergiants":"RPS","Gujarat Lions":"GL", "Pune Warriors":"PW"}, inplace=True)
    ...
    encode = {'toss_winner': {'KKR':0,'CSK':1,'RR':2,'MI':3,'SRH':4,'KXIP':5,'RCB':6,'DC':7,'KTK':8,'RPS':9,'GL':10,'PW':11},'winner': {'KKR':0,'CSK':1,'RR':2,'MI':3,'SRH':4,'KXIP':5,'RCB':6,'DC':7,'KTK':8,'RPS':9,'GL':10,'PW':11,'Draw':12}}
